...
<div class="container">
    <a class="btn btn-primary mt-2" href="{{route('users.create')}}"> Add new user</a>
    <div class="card  mt-2">
        <h3 class ="card-header text-center">Danh sach hoc vien di muon</h3>
        <table class="table">
            <tr>
                <td>STT</td>
            ...
            @foreach($users as $key => $user)
                <tr class="user-item" id="user-item-{{$user->id}}">
                    ...
                    <td>
                        <button type="button" data-id="{{$user->id}}" class="btn btn-warning delete-user-item">Edit</button></td>
